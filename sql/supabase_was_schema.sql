-- Engine schema isolated in was; vector type from extensions schema (Supabase).
create schema if not exists was;
create extension if not exists vector with schema extensions;
create extension if not exists pgcrypto with schema extensions;
set search_path = was, public, extensions;
-- =============================================================================
...
DECLARE
    ...
    v_seq INT;
BEGIN
    INSERT INTO was.ticket_counters (business_id, day, last_seq)
    VALUES (p_business_id, v_day, 1)
    ON CONFLICT (business_id, day)
    DO UPDATE SET last_seq = was.ticket_counters.last_seq + 1
